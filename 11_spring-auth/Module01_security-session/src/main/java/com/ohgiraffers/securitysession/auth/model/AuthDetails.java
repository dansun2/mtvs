...
public class AuthDetails implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        Collection<GrantedAuthority> authorities = new ArrayList<>(); // 인증객체는 항상 GrantedAuthority로 맞춰줘야함. 여기서 꺼내야됨.
     ...
     * 여기서 추출해서 UsernamePasswordAuthenticationToken과 사용자의 비밀번호를 비교할 때 사용된다.
     * */
    @Override
