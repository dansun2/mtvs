...
public class MemberService {
    ...
    public Member getMember(String email) {
        ...
        try {
            System.out.println("[로그] 회원조회 시작 : " + email);
            ...
            //로깅
            System.out.println("[로그] 회원조회 성공 : " + member.getEmail());
            return member;
        } catch (Exception e) {
            // 로깅
            System.out.println("[로그] 회원조회 실패 : " + email);
            throw new RuntimeException(e);
        } finally {
            long endTime = System.currentTimeMillis();
    ...
    public void deleteMember(String email) {
        ...
        try {
            ...
            // 로깅
            System.out.println("[로그] 회원탈퇴 실패 : " + email);
