    ...
    return (
        <div>
            ...
            <section>
                <h2>함수형 컴포넌트 정의</h2>
                <p>
                    <strong>함수형 컴포넌트</strong>는 props를 입력으로 받아 React 엘리먼트를 반환하는 JavaScript 함수이다.
                    함수형 컴포넌트는 간결하고 직관적이며, 최신 React 개발의 중심이 되는 방식이다.
                </p>
            ...
            <section>
                <h2>props 사용하기</h2>
                <p>
                    <strong>props</strong>(properties의 줄임말)는 컴포넌트에 전달되는 데이터이다.
                ...
                <div>
                    <h3>실제 props 예제</h3>
                    <UserProfile name="홍길동" job="개발자" age={30} />
                    <UserProfile name="김철수" job="디자이너" age={28} />
                </div>
            </section>
            ...
            <section>
                ...
                <p>
                    <strong>children</strong>은 특별한 prop으로, 컴포넌트의 여는 태그와 닫는 태그 사이에 있는
                    내용을 가리킨다. 이를 통해 컴포넌트를 더 유연하게 구성할 수 있다.
                </p>
